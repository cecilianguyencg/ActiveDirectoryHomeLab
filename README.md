...
1. Open up Edge browser from the toolbar. Download the zip file containing the scripts from my GitHub [here](https://github.com/cecilianguyencg/ActiveDirectoryHomeLab/archive/master.zip) by copying and pasting the link into Edge. 
...
11. Change dropdown option **_USERS** to **Entire Directory** and type in your first name then click **Find Now**. Two accounts should show up with your first name, the administrator one we created and one we added to the **names.txt** earlier. In my case, a third account with the first name of Cecilia because it was created from the **Generate-Names-Create-Users** script. Crazy!
...
18. Click **OK** and then enter in a username and password that was created on our first virtual machine, the **Domain Controller**. A window will appear indicating this client machine is part of the **mydomain.com** domain. Click **OK**, **OK**, then restart for changes to go into effect. 
